...
(pp.~96--101). El fragmento del libro donde aparece se muestra en la figura~\ref{imagen-libro}.

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{partition3-libro.png}
    \caption{Fragmento del libro de Garey y Johnson donde se presenta el problema de la 3-Partición y el comienzo de los teoremas que se mencionan.}
    \label{imagen-libro}
\end{figure}
